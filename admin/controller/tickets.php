...
$htmlContent = "Hello,
You have a new message in the ticket.<br>
Follow the link below to see the message:
<br><a href='" . site_url() . "tickets/" . route(3) . "'>
    <button style='padding: 10px 15px; background-color: #4CAF50; color: white; border: none; cursor: pointer; margin-top: 10px;'>
        View Message
    </button>
</a><br><br>
Best regards,<br>
<a href='https://www.smmpaw.com' target='_blank'>www.smmpaw.com</a>";
$to = $user['email']; 
...
// custom smmpaw panel sendmail function 
     if($to){ 
