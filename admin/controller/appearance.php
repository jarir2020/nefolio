   ...
   $access = $admin["access"]["pages"];
      ...
      if( $access ):
        if( $_POST ):
          ...
          whatsappcolour=:whatsappcolour,
          whatsappposition=:whatsappposition,
          telegrambutton=:telegrambutton,
          telegramusername=:telegramusername,
          telegramposition=:telegramposition,
          theme_bg_img=:psw_img
           WHERE id=:id ");
          $update = $update->execute(array("id"=>1,
          "whatsappbutton" => $_POST['whatsappbutton'],
          "whatsappnumber" => $_POST['whatsappnumber'],
          "whatsappcolour" => $_POST['whatsappcolour'],
          "whatsappposition" => $_POST['whatsappposition'],
          "telegrambutton" => $_POST['telegrambutton'],
          "telegramusername" => $_POST['telegramusername'],
          "telegramposition" => $_POST['telegramposition'],
          "psw_img" => $_POST['psw_img']));
          if( $update ):
            $conn->commit();
            header("Location:".site_url("admin/appearance/whatsapp-telegram"));
            $_SESSION["client"]["data"]["success"]    = 1;
            $_SESSION["client"]["data"]["successText"]= "Success";
          else:
            $conn->rollBack();
