...
if ($paymentMethod->rowCount()) {
    ...
    if ($callbackSlug == "sfspay") {
        require("payment/sfspay.php");
        exit;
    }
    ...
    if ($callbackSlug == "binance") {
        require("payment/binance.php");
        exit;
    }
    if ($callbackSlug == "bkash") {
        require("payment/bkash.php");
        exit;
    }
    if ($callbackSlug == "alphapaybd") {
        require("payment/alphapaybd.php");
        exit;
    }
    if ($callbackSlug == "nethosit") {
        require("payment/nexsopay.php");
        exit;
    }
    if ($callbackSlug == "cryptomus") {
        require("payment/cryptomus.php");
        exit;
    }
    if ($callbackSlug == "heleket") { 
        require("payment/heleket.php");
        exit;
    }
    if ($callbackSlug == "bybit") {
        require("payment/bybit.php");
        exit;
    }
    ...
    if ($callbackSlug == "manual_payment") {
        require("payment/manual_payment.php");
        exit;
    }
} else {
    errorExit("Invalid payment method callback.");
