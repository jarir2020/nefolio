...
$google_login_content = '
    <div style="text-align: center; margin-top: 20px;">
        <button type="button" id="login-with-google-btn" 
            class="btn btn__signin" 
            onclick="window.location.href=\'?login-with-google\';"
            style="background-color: #4285F4; color: white; border: none; padding: 10px 20px; border-radius: 5px; font-size: 16px; cursor: pointer;">
