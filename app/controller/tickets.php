...
$htmlContent = "
    <p>Hello,</p>
    <p>You have a new message in the ticket. Follow the link below to see the message:</p>
    
    <a href='".site_url()."admin/tickets/read/".$ticket_id."' 
    ...
    <p>Best regards,</p>
    <p><a href='https://www.bdclick24.com' style='text-decoration:none; color:#007bff;'>www.bdclick24.com</a></p>
";
...
// custom bdclick24 panel sendmail function 
     if($to){ 
 sendMail(["subject"=>$subject,"body"=>$htmlContent,"mail"=>$to]);
    }
...
<a href='". site_url()."admin/tickets?search=unread/".$ticket_id."'>
<button style='padding: 10px 15px; background-color: #4CAF50; color: white; border: none; cursor: pointer;'>
    View Message
</button>
</a><br><br>
Best regards,<br>
<a href='https://www.bdclick24.com' target='_blank'>www.bdclick24.com</a>";
$to = $settings["admin_mail"]; 
$from = $settings["smtp_user"];  
$fromName = $settings["site_seo"]; 
$subject = "New Message"; 
...
// custom sfs panel sendmail function 
     if($to){ 
 sendMail(["subject"=>$subject,"body"=>$htmlContent,"mail"=>$to]);
    }
