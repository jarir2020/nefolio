...
$results[] = addColumnIfMissing($conn, "paymentmethods", "methodShortName", "VARCHAR(100) DEFAULT NULL AFTER `methodVisibleName`");
$results[] = addColumnIfMissing($conn, "paymentmethods", "dollarRateConversionEnabled", "TINYINT(1) NOT NULL DEFAULT 1 AFTER `methodBonusEnabled`");
